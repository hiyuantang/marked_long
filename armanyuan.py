...
# Baseline WITH DivNorm Layers
# python3 armanyuan.py <path> -d 1

# Baseline WITHOUT DivNorm Layers
# python3 armanyuan.py <path> -d 0
...
parser.add_argument('-a', '--arch', metavar='ARCH', default='baseline')
