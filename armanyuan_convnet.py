...
parser.add_argument('--divei', metavar='DIVEI', type=int, default=0) # 0 = w/o DivNormEI, 1 = with DivNormEI
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if str(args.arch) == "baseline":
        divnormei_choice = bool(args.divei)
        print("=> creating model: '{}' | DivNormLayers: {}".format(args.arch, divnormei_choice))
        model = BaselineDivNorm(divnormei_choice)
    elif str(args.arch) == "baseline_f1":
        divnormei_choice = bool(args.divei)
        eidivnorm_choice = bool(args.eidiv)
        model = BaselineF1(divnormei=divnormei_choice, eidivnorm=eidivnorm_choice, 
                            L3=(args.layers==3), L5=(args.layers==5), L7=(args.layers==7))
        if args.layers == 3:
            print('Creating a 3-layer convnet | DivNormEILayers: {} | EIDivNormLayers: {}'.format(divnormei_choice, eidivnorm_choice))
        elif args.layers == 5:
            print('Creating a 5-layer convnet | DivNormEILayers: {} | EIDivNormLayers: {}'.format(divnormei_choice, eidivnorm_choice))
        elif args.layers == 7:
            print('Creating a 7-layer convnet | DivNormEILayers: {} | EIDivNormLayers: {}'.format(divnormei_choice, eidivnorm_choice))
    ...
    #                                  std=[0.23, 0.23, 0.23])
    normalize = transforms.Normalize(mean=[0.0054, 0.0053, 0.0053],
                                      std=[0.0421, 0.0417, 0.0417])
